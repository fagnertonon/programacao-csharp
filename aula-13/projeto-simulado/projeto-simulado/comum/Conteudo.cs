...
namespace Conecta
{
    ...
    // conteudo-simulado.json - a fonte unica que alimenta o aplicativo.
    //
    ...
    public class Conteudo
    {
        ...
        {
            string caminho = Path.Combine(AppContext.BaseDirectory, "conteudo-simulado.json");

            if (!File.Exists(caminho))
            {
                throw new FileNotFoundException(
                    "Nao encontrei o conteudo-simulado.json ao lado do executavel.\r\n" +
                    "Procurei em: " + caminho + "\r\n\r\n" +
