...
namespace Conecta
{
    ...
    public class frmSimulado : Form
    {
        ...
        public frmSimulado()
        {
            ...
            {
                MessageBox.Show(
                    "Nao consegui montar o aplicativo a partir do conteudo-simulado.json."
                    + "\r\n\r\n" + ex.Message,
        ...
        private void MontarJanela()
        {
            ...
            btnFoco.Location = new Point(ClientSize.Width - 570, 10);
            ...
            btnEnviar.Location = new Point(ClientSize.Width - 230, 9);
            ...
            btnNaoEntra.Location = new Point(ClientSize.Width - 450, 10);
        ...
        private void MostrarResultadoDoEnvio(ResultadoEnvio env, List<RespostaAluno> lista)
        {
            ...
            if (!env.BancoTentado)
            {
                texto += "O envio para o servidor nao esta configurado neste "
                       + "aplicativo. O professor recolhe o arquivo acima.";
