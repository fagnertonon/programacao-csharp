...
namespace Conecta
{
    ...
    //
    //   Numa caixa de texto o algoritmo pode ser selecionado, copiado com
    //   Ctrl+C e colado no Desafios.cs. E o Portugol e tao parecido com o
    //   C# que colar e ajustar sairia mais rapido do que traduzir - e ai o
    //   exercicio da noite deixa de acontecer.
    //
    ...
    //
    // GEMEA: este arquivo tem uma copia em projeto-desafio/CaixaDeCodigo.cs.
    // Sao dois projetos separados, que vao para a maquina do aluno em
    // pastas diferentes - por isso a copia. Mexeu num, mexa no outro.
    // =====================================================================
